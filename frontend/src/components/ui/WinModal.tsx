...
const WinModal = ({ isOpen, rewardAmount, onClose }: WinModalProps) => {
  ...
  return (
    <Dialog open={isOpen}>
      <DialogContent className="py-8 px-16 flex flex-col gap-8 text-center [&>button]:hidden">
        <DialogHeader>
          <DialogTitle className="text-5xl font-semibold flex items-center justify-center gap-4">
        ...
        <div className="flex justify-center gap-4 ">
          <Button variant="secondary" onClick={() => console.log("Главное меню")}>
